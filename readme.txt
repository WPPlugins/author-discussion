...
= 0.1.3 =
* Fixed a major bug introduced in a taken down version of 0.1.2
* Minor bug-fixes

= 0.1.2 =
* Added jQuery Library for future updates
* Minor bug-fixes

= 0.1.1 =
* Updated Author URI and Plugin URI for easy access to support/reviews

= 0.1.0 =
* No previous public versions
